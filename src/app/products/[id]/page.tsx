...
export default function Page({params}:{
    ...
    const {pickedItem,  handleBasketState, addToCart, handleItemQuantity} = useShoppingCart();
    ...
    return (
              ...
              <div 
                className=" py-8 h-full sm:gap-2 flex flex-col sm:flex-row items-center text-black
                 ">
                    {/*img div */}
                    <div 
                    ...
                    {/*Item details div */}
                    <div className="h-a  sm:max-h-[44rem]  sm:w-1/2 
                    ...
                    flex flex-col justify-between">
                        ...
                        <div className="mb-2 h-[h/2]">
                             <p className=" text-sm leading-6 truncate ">{pickedItem.description}</p>
                        </div>
                        {/*QUANTITY*/}
                        <div className="mb-4">
