...
export default function CheckOutItemCard() {
    ...
    return (<>
        ...
        {cartItems.map((item)=>(
            <div key={item.id} 
            className="flex  shadow-newco rounded-xl p-6 mb-8 w-full">
                ...
                <div className="flex justify-between items-center ">
                    ...
                    <div className="flex gap-10">{/* Item's numbers */}
                        ...
                        <div className="flex lg:items-center"> {/* Item price and delete div */}
                            <h3 
